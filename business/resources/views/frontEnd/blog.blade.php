        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <img src="{{ asset("assets") }}/images/slider-dec-v3.png" alt="">
            </div>
          </div>
        </div>
      </div>
                    ...
                    <div>
                      <div class="thumb">
                        <div class="row">
                          ...
                          <div class="col-lg-6 align-self-center">
                            <div class="right-image">
                              <img src="{{ asset("assets") }}/images/services-image-02.jpg" alt="">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div>
                      <div class="thumb">
                        <div class="row">
                          ...
                          <div class="col-lg-6 align-self-center">
                            <div class="right-image">
                              <img src="{{ asset("assets") }}/images/services-image-03.jpg" alt="">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div>
                      <div class="thumb">
                        <div class="row">
                          ...
                          <div class="col-lg-6 align-self-center">
                            <div class="right-image">
                              <img src="{{ asset("assets") }}/images/services-image-04.jpg" alt="">
                            </div>
                          </div>
                        </div>
                      </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
        <div class="blog-post">
          <div class="thumb">
            <a href="#"><img src="{{ asset("assets") }}/images/blog-post-01.jpg" alt=""></a>
          </div>
          <div class="down-content">
            ...
            <span class="author"><img src="{{ asset("assets") }}/images/author-post.jpg" alt="">By: Andrea Mentuzi</span>
